      ...
      template = [
        {
          ...
          sensor = [
            ...
            }
            {
              ...
              # timestamp sensor (this is the ROOM sensor's freshness, not an AC
              # reading), so it can be selected in the Living Room Versatile Thermostat's
              ...
              unique_id = "living_room_temp_last_seen";
            ...
            {
              name = "Basement Temperature Last Seen";
              unique_id = "basement_temp_last_seen";
              device_class = "timestamp";
